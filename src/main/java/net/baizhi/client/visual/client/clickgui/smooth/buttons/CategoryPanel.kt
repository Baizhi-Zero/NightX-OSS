...
import net.baizhi.client.visual.client.clickgui.smooth.SmoothConstants.PANEL_HEIGHT

import net.baizhi.client.visual.client.clickgui.smooth.SmoothConstants.PANEL_WIDTH
