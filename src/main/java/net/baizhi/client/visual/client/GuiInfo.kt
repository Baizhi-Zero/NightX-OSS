package net.baizhi.client.visual.client

import net.baizhi.client.utils.APIConnecter
import net.baizhi.client.utils.URLComponent
...
class GuiInfo(private val prevGui: GuiScreen) : GuiScreen() {
    ...
    override fun initGui() {
        buttonList.add(GuiButton(1, width / 2 - 100, height / 4 + 44, "Open NightX-OSS Website"))
