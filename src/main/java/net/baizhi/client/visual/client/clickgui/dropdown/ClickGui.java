package net.baizhi.client.visual.client.clickgui.dropdown;
...
import net.baizhi.client.features.module.impl.visual.Gui;
import net.baizhi.client.utils.render.EaseUtils;
...
import net.baizhi.client.visual.client.clickgui.dropdown.elements.Element;
import net.baizhi.client.visual.client.clickgui.dropdown.elements.ModuleElement;
import net.baizhi.client.visual.client.clickgui.dropdown.style.Style;
import net.baizhi.client.visual.client.clickgui.dropdown.style.styles.DropDown;
import net.baizhi.client.visual.font.semi.AWTFontRenderer;
...
public class ClickGui extends GuiScreen {
    ...
    public void drawScreen(int mouseX, int mouseY, final float partialTicks) {
        ...
        if (progress < 1) progress = (float) (System.currentTimeMillis() - lastMS) / (600F / 1.4F);
        else progress = 1;
