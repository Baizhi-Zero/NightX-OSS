...
import net.baizhi.client.utils.MouseButtons

import net.baizhi.client.utils.geom.Rectangle

import net.baizhi.client.utils.render.RenderUtils.drawRect

import net.baizhi.client.value.*

import net.baizhi.client.visual.client.clickgui.smooth.SmoothConstants.BACKGROUND_MODULE
...
import net.baizhi.client.visual.client.clickgui.smooth.SmoothConstants.VALUE_HEIGHT

import net.baizhi.client.visual.client.clickgui.smooth.buttons.value.*

import net.baizhi.client.visual.client.clickgui.smooth.drawHeightCenteredString

import net.baizhi.client.visual.client.clickgui.smooth.getHeight
