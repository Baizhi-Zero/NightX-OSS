...
import net.baizhi.client.features.module.impl.movement.speeds.aac.*
import net.baizhi.client.features.module.impl.movement.speeds.matrix.Matrix670
import net.baizhi.client.features.module.impl.movement.speeds.matrix.Matrix692
import net.baizhi.client.features.module.impl.movement.speeds.matrix.MatrixHop
import net.baizhi.client.features.module.impl.movement.speeds.matrix.MatrixYPort
import net.baizhi.client.features.module.impl.movement.speeds.ncp.*
import net.baizhi.client.features.module.impl.movement.speeds.server.*
import net.baizhi.client.features.module.impl.movement.speeds.spartan.SpartanYPort
import net.baizhi.client.features.module.impl.movement.speeds.velocity.Velocity
import net.baizhi.client.features.module.impl.movement.speeds.verus.VerusFloat
import net.baizhi.client.features.module.impl.movement.speeds.verus.VerusHop
import net.baizhi.client.features.module.impl.movement.speeds.verus.VerusLowHop
import net.baizhi.client.features.module.impl.movement.speeds.vulcan.VulcanYPort
import net.baizhi.client.features.module.impl.movement.speeds.watchdog.WatchdogCustom
import net.baizhi.client.features.module.impl.movement.speeds.watchdog.WatchdogGround
