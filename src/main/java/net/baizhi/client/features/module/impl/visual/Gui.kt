...
import net.baizhi.client.utils.render.ColorUtils.LiquidSlowly
import net.baizhi.client.utils.render.ColorUtils.fade
...
class Gui : Module() {
    private val styleValue: ListValue = object : ListValue(
        "Style",
        arrayOf("Modern", "Smooth", "DropDown", "Tab"),
        "Modern"
    ) {
    }
    ...
    override fun onEnable() {
        ...
        when (styleValue.get().lowercase(Locale.getDefault())) {
            ...
            "modern" -> mc.displayGuiScreen(ModernClickGui())
        }
    }
