...
import net.baizhi.client.utils.CooldownHelper
...
class KillAuraRecode : Module() {
    ...
    private val maxTurnSpeed: FloatValue = object : FloatValue("MaxTurnSpeed", 80f, 0f, 180f, "掳") {
        override fun onChanged(oldValue: Float, newValue: Float) {
            val v = minTurnSpeed.get()
            if (v > newValue) set(v)
        }
    }
    private val minTurnSpeed: FloatValue = object : FloatValue("MinTurnSpeed", 40f, 0f, 180f, "掳") {
        override fun onChanged(oldValue: Float, newValue: Float) {
    ...
    private val fovValue = FloatValue("Fov", 180F, 0F, 180F, "掳")
